...
#     dataset1 = np.random.randn(2080, NUM_FEATURES+1)
#     dataset2 = np.random.randn(52, NUM_FEATURES+1)
...
#     dataset1 = np.random.randn(338, NUM_FEATURES+1)
#     dataset2 = np.random.randn(338, NUM_FEATURES+1)
#     dataset3 = np.random.randn(338, NUM_FEATURES+1)
#     dataset4 = np.random.randn(338, NUM_FEATURES+1)
#     datasets.append(dataset1)
#     datasets.append(dataset2)
...
def get_m_coded(dataset_ind):
    if my_rank <= 3:
        dataset_size = [2080, 52]
        return dataset_size[dataset_ind]
    else:
        dataset_size = [338, 338, 338, 338]
        return dataset_size[dataset_ind]
